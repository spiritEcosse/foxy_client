...
const CheckoutComponent = () => {
  ...
  return (
    <div style={{ padding: "20px" }}>
      <Alert severity="info">
        Please be advised that this action is currently in the testing phase,
        which will entail placing a test order.
      </Alert>
      <h1>Checkout</h1>
      <Accordion
      ...
      >
        ...
        >
          <Typography sx={{ width: "33%", flexShrink: 0 }}>Cart</Typography>
          <Typography sx={{ color: "text.secondary" }}>
            You have count of items: {basketItems.length}. Total price is{" "}
            ...
            {basketItems.map((basketItem, index) => (
              <Grid item xs={12} key={basketItem.id}>
                <Grid container spacing={2} alignItems="center">
                  ...
                  <Grid item xs={2}>
                    {`${(
                      basketItem.item.price * basketItem.quantity
